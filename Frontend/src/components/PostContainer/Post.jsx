...
export default function Post({post}) {
    ...
    // eslint-disable-next-line react/prop-types
    const [Like, setLike] = useState(post.like.includes(userId) ? anotheLikeIcon : LikeIcon);
    // eslint-disable-next-line react/prop-types
    ...
    const addComment = async () => {
        ...
        try {
            // eslint-disable-next-line react/prop-types
            const updatedPostData = await commentOnPost(post._id, comment);
        ...
        <div className='PostContainer'>
            <div className='SubPostContainer'>
                <div>
                    ...
                    {/* eslint-disable-next-line react/prop-types */}
                    <p style={{ textAlign: 'start', width: "96%", marginLeft: 20, marginTop: 0 }}>{post.author}</p>
                    {/* eslint-disable-next-line react/prop-types */}
                    <p style={{ textAlign: 'start', width: "96%", marginLeft: 20, marginTop: 0 }}>{post.description}</p>
                    {/* eslint-disable-next-line react/prop-types */}
