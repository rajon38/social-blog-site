...
const Registration = () => {
    ...
    let emailRef,firstNameRef,lastNameRef,usernameRef,phoneNumberRef,passwordRef=useRef();
    ...
    const onRegistration = async () => {
        ...
        if (IsEmail(email)) {
            ...
            let result = await RegistrationRequest(firstName,lastName,profile,username,phoneNumber,email,password)
            if (result === true) {
                navigate("/login")
            }
        }
                        ...
                        <div className="card-body">
                            ...
                            <div className="row m-0 p-0">
                                    ...
                                    <div className="col-md-4 text-start p-2">
                                        ...
                                        <input ref={(input)=>usernameRef=input} placeholder="username" className="form-control" type="text"/>
                                    </div>
                                    <div className="col-md-4 text-start p-2">
                                        <label>Phone Number</label>
                                        <input ref={(input)=>phoneNumberRef=input} placeholder="Mobile" className="form-control" type="tel"/>
                                    </div>
                                    <div className="col-md-4 text-start p-2">
